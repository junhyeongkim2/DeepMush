...
| 분류          | 기술                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| :------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | 
| CI/CD      | ![Terraform](https://img.shields.io/badge/Terraform-black?logo=Terraform) ![GithubActions](https://img.shields.io/badge/GithubActions-black?logo=GithubActions) ![AmazonAWS](https://img.shields.io/badge/AmazonAWS-black?logo=AmazonAWS)                                                                                                                                                                                                                                                                                   |
