...
| 분류          | 기술                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 개발환경      | ![GitHubActions](https://img.shields.io/badge/GitHubActions-yellow?logo=GitHubActions) ![Kubernetes](https://img.shields.io/badge/Kubernetes-black?logo=Kubernetes) ![S3](https://img.shields.io/badge/S3-orange?logo=AmazonS3)                                                                                                                                                                                                                                                                                     |
