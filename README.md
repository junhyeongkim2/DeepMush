...
| 분류          | 기술                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 개발환경      | ![GitHub Actions](https://img.shields.io/badge/GitHub Actions-2088FF?logo=GitHub Actions) ![Kubernetes](https://img.shields.io/badge/Kubernetes-skyblue?logo=Kubernetes) ![S3](https://img.shields.io/badge/S3-orange?logo=AmazonS3)                                                                                                                                                                                                                                                                                     |
...
| [Backend](backend/README.md)      | ![RabbitMQ](https://img.shields.io/badge/RabbitMQ-FF6600?logo=RabbitMQ) ![Elasticsearch](https://img.shields.io/badge/Elasticsearch-005571?logo=Elasticsearch) ![Gunicorn](https://img.shields.io/badge/gunicorn-gray?logo=gunicorn) ![Swagger](https://img.shields.io/badge/swagger-gray?logo=swagger)                                                                                                                                   |
