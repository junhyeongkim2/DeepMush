...
| 분류          | 기술                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 개발환경      | ![GitHubActions](https://img.shields.io/badge/GitHubActions-2088FF?logo=GitHub Actions) ![Kubernetes](https://img.shields.io/badge/Kubernetes-skyblue?logo=Kubernetes) ![S3](https://img.shields.io/badge/S3-orange?logo=AmazonS3)                                                                                                                                                                                                                                                                                     |
